...
const dict: I18nDict = {
  en: {
    ...
    'overview.step2.desc': 'Our AI analyzes your documents and intelligently maps them to relevant standards. Missing or outdated sections are automatically identified, ensuring your documentation remains current and compliant.',
  ...
  tr: {
    ...
    'overview.step2.desc': 'Yapay zekâ, dokümanlarınızı analiz ederek ilgili standartlarla akıllıca eşleştirir. Eksik ya da güncellenmesi gereken bölümler otomatik olarak tespit edilir; böylece dokümantasyonunuz her zaman güncel ve uyumlu kalır.',
    'overview.step2.tag': 'Yapay zekâ ile doküman analizi',
    'overview.step3.title': 'Sürekli denetime hazır kalın',
    'overview.step3.desc': 'Kanıtlar canlı ve izlenebilirdir. CERTI her revizyonu takip eder, denetim öncesi ön kontroller yapar.',
