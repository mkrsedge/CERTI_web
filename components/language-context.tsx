...
const dict: I18nDict = {
  en: {
    ...
    'modules.2.desc': 'İç, müşteri veya belgelendirme denetimlerinizi; kanıtlı bulgu kaydı, görevleştirme ve sorumlu atama ile tek bir platformda dijitalleştirin.',
