...
const dict: I18nDict = {
  ...
  tr: {
    ...
    'hero.desc.2': 'Düzenlemeye tabi sektörler için tasarlanmış ajan tabanlı yapay zeka.',
    ...
    'overview.step1.desc': 'Sürücülerinizi ve sistemlerinizi bağlayın. CERTI iş akışınıza uyum sağlar; veri, karmaşık taşımalar olmadan içeri akar.',
    'overview.step1.tag': 'API-öncelikli entegrasyon',
    'overview.step2.title': 'CERTI kurumunuzu öğrenir',
    'overview.step2.desc': 'Yapay zekâ SOP’larınızı, HACCP planlarınızı ve politikalarınızı okur; uyduğunuz standartlara eşler.',
    'overview.step2.tag': 'Yapay zekâ ile doküman analizi',
    'overview.step3.title': 'Sürekli denetime hazır kalın',
    'overview.step3.desc': 'Kanıtlar canlı ve izlenebilirdir. CERTI her revizyonu izler, sahaya çıkmadan önce ön kontroller yapar.',
    'overview.step3.tag': 'Gerçek zamanlı izleme',
    'overview.step4.title': 'Sorunları kalıcı olarak çözün',
    'overview.step4.desc': 'Sorunlar ortaya çıktığında CERTI kök neden analizini yönlendirir ve prosedürlerinize dayalı doğru DÖF/CAPA taslakları üretir.',
    'overview.step4.tag': 'YZ destekli CAPA iş akışı',
    'overview.step5.title': 'Güvenilirliği kanıtlayın, geliri koruyun',
    'overview.step5.desc': 'Her daim hazır kanıtlar ve kapalı devre CAPA ile bulguları azaltır, müşteri güvenini korur, yüksek değerli sözleşmeleri güvence altına alırsınız.',
    ...
    'overview.cap.3.desc': 'YZ içgörüleriyle riskleri tespit ve azaltma.',
    ...
    'modules.2.desc': 'Tüm denetimlerinizi—iç, müşteri veya belgelendirme—tek platformda bulgular, kanıtlar ve atamalarla dijitize edin.',
    'modules.3.title': 'Üretim Hattı Sorun Giderme',
    'modules.3.sub': 'Saha Çözümleri',
    'modules.3.desc': 'Kılavuzlu kök neden analizi ve görev bazlı takip ile hat sorunlarını daha hızlı çözün.',
    'modules.4.title': 'Müşteri Şikayeti Çözümü',
    'modules.4.sub': 'Yapılandırılmış Vaka Yönetimi',
    'modules.4.desc': 'Şikayetleri SOP’lara bağlı CAPA ve etkililik kontrolleriyle kalıcı çözümlere dönüştürün.',
    ...
    'demo.expect.1.sub': 'Özel kullanım senaryonuza uyarlanır',
    'demo.expect.2.title': 'Canlı Soru-Cevap',
    'demo.expect.2.sub': 'Sorularınıza uzmanlar cevap verir',
    'demo.expect.3.title': 'Özel uygulama planı',
    'demo.expect.3.sub': 'Kuruluşunuza özel bir yol haritası alın',
    ...
    'pricing.sub': 'Basit başlayın, büyüdükçe ekleyin. Tüm paketlerde YZ destekli çekirdek kalite özellikleri bulunur.',
    'pricing.transparent': 'Şeffaf Fiyatlandırma',
    'pricing.transparent.sub': 'Kuruluşunuzun boyutuna ve ihtiyacına göre kişiselleştirilmiş fiyat alın.',
    ...
    'pricing.includedEvery.ai': 'YZ İçgörüleri',
