...
const dict: I18nDict = {
  en: {
    ...
    'demo.lead': 'Platformumuzu canli görün. Uzmanlarimizla kisisellestirilmis bir demo planlayin ve operasyonlarinizi nasil dönüstürebilecegimizi kesfedin.',
    'demo.expect.title': 'Sizi Neler Bekliyor',
    'demo.expect.1.title': '30 dakikalik kisisellestirilmis demo',
    'demo.expect.1.sub': 'Sizin kullanim senaryonuza göre uyarlanir',
    'demo.expect.2.title': 'Canli Soru-Cevap',
    'demo.expect.2.sub': 'Sorulariniza uzmanlarimiz yanit verir',
    'demo.expect.3.title': 'Özel uygulama plani',
    'demo.expect.3.sub': 'Organizasyonunuz için yol haritasi sunulur',
    ...
    'hero.desc.1': 'Üreticiler için kalite yönetiminde yeni bir çag.',
    'hero.desc.2': 'Ajan tabanli yapay zeka teknolojileri, agir düzenlemeli sektörlere özel.',
    'hero.cta.primary': 'Demo Talep Et',
    'hero.cta.secondary': 'Daha Fazla Bilgi',
    'hero.kpi.1': 'Uyumluluk',
    'hero.kpi.2': 'Daha Hizli Denetimler',
    'hero.kpi.3': 'Daha Düsük Maliyet',

    // Overview journey
    'overview.capabilities': 'CERTI ile Yapabilecekleriniz',
    'overview.header': 'CERTI Yolculugunuza Baslayin',
    'overview.sub': 'Kalite yönetiminizi kaostan kontrollü mükemmellige tasiyan sorunsuz entegrasyon ve basari yolunu izleyin.',
    'overview.step1.title': 'Kalite dünyanizi baglayin',
    'overview.step1.desc': 'Sürücü ve sistemlerinizi baglayin; CERTI is akisiniza sorunsuzca oturur, veriler karmasik tasimalara gerek kalmadan akar.',
    'overview.step1.tag': 'API-öncelikli entegrasyon',
    'overview.step2.title': 'CERTI sirketinizi ögrenir',
    ...
    'overview.step3.title': 'Sürekli denetime hazir kalin',
    'overview.step3.desc': 'Kanitlar canli ve izlenebilir kalir. CERTI her revizyonu izler; sahaya çikmadan önce ön kontrolleri yapar.',
    'overview.step3.tag': 'Gerçek zamanli izleme',
    'overview.step4.title': 'Sorunlari kalici olarak çözün',
    'overview.step4.desc': 'Sorunlar ortaya çiktiginda CERTI kök neden analizine rehberlik eder ve prosedürlerinize göre net DÖF taslaklari olusturur.',
    'overview.step4.tag': 'Yapay zeka rehberli DÖF',
    'overview.step5.title': 'Güvenilirliginizi kanitlayin, geliri koruyun',
    'overview.step5.desc': 'Her zaman hazir kanit ve kapali döngü DÖF ile bulgulari azaltir, müsteri güvenini korur ve yüksek degerli sözlesmeleri güvenceye alirsiniz.',
    'overview.step5.tag': 'Is etkisi',
    'overview.goto': 'Adima git',

    // Overview capabilities slider
    'overview.cap.1.title': 'Doküman Kontrolü',
    'overview.cap.1.desc': 'Onay ve versiyonlama ile dokümanlari merkezilestirin.',
    'overview.cap.2.title': 'Denetim Yönetimi',
    'overview.cap.2.desc': 'Kontrol listeleri ve gerçek zamanli raporlamayla denetimleri yönetin.',
    'overview.cap.3.title': 'Risk Degerlendirme',
    'overview.cap.3.desc': 'Yapay zeka içgörüleriyle riskleri belirleyip azaltin.',
    'overview.cap.4.title': 'Egitim ve Sertifikasyon',
    'overview.cap.4.desc': 'Egitimleri ve sertifikalari her zaman güncel tutun.',
    'overview.cap.5.title': 'Tedarikçi Kalitesi',
    'overview.cap.5.desc': 'Puan kartlari ve olay kayitlariyla tedarikçi kalitesini izleyin.',
    'overview.cap.6.title': 'Raporlama Paneli',
    'overview.cap.6.desc': 'Canli metrikleri ve uyum durumunu görün.',

    // Modules
    'modules.header': 'Kullanim Senaryolari',
    'modules.sub': 'CERTI’nin doküman yönetiminden müsteri memnuniyetine kadar üretim operasyonlarinizda kaliteyi nasil dönüstürdügünü kesfedin.',
    'modules.1.title': 'Akilli Doküman Yönetimi',
    'modules.1.sub': 'Akilli Doküman Kontrolü',
    'modules.1.desc': 'Tüm uyum dokümanlarini ilgili standartlarin gereklilikleriyle akilli sekilde esleyerek merkezilestirin; yeni ürün devreye alma gibi durumlarda yapay zeka destekli güncellemelerle hiz kazanin.',
    'modules.2.title': 'Denetime Hazirlik',
    'modules.2.sub': 'Entegre Denetim Yönetimi',
    'modules.2.desc': 'Iç, müsteri veya belgelendirme denetimlerinizi; kanitli bulgu kaydi, görevlestirme ve sorumlu atama ile tek bir platformda dijitallestirin.',
    'modules.3.title': 'Üretim Sorun Giderme',
    'modules.3.sub': 'Saha Çözümleri',
    'modules.3.desc': 'Kök neden analizine rehberlik ve görev bazli aksiyon takibi ile üretim hattindaki sorunlari hizla çözün; durus sürelerini azaltin.',
    'modules.4.title': 'Müsteri Memnuniyeti Yönetimi',
    'modules.4.sub': 'Yapilandirilmis Vaka Yönetimi',
    'modules.4.desc': 'Sikayetleri yapilandirilmis vakalara dönüstürün, kök nedenleri belirleyin, yapay zeka önerileri ile düzeltici eylemleri uygulayin ve müsterilerinizle paylasabileceginiz net özet raporlar üretin.',

    // Pricing
    'pricing.header': 'CERTI Paketinizi Seçin',
    'pricing.sub': 'Temelden baslayin, büyüdükçe ekleyin. Tüm paketlerde yapay zeka destekli çekirdek kalite özellikleri bulunur.',
    'pricing.transparent': 'Seffaf Fiyatlandirma',
    'pricing.transparent.sub': 'Organizasyonunuzun boyutuna ve ihtiyaçlarina göre kisisellestirilmis fiyat alin',
    'pricing.included.title': 'Her Pakette Neler Var',
    'pricing.cta.header': 'Baslamaya hazir misiniz?',
    'pricing.cta.body': 'Kisisellestirilmis fiyat alin ve hangi paketin size uygun oldugunu görün',
    'pricing.cta.button': 'Fiyat Alin',
    'pricing.compare': 'Paketleri Karsilastirin',
    'pricing.compare.sub': 'Tüm CERTI paketlerinde ayrintili özellik karsilastirmasi',
    'pricing.extra.title': 'Özel Bir Çözüm mü Lazim?',
    'pricing.extra.body': 'Organizasyonunuzun ihtiyaç ve ölçegine özel bir paket hazirlayabiliriz.',
    'pricing.extra.cta1': 'Satis ile Iletisime Geçin',
    'pricing.extra.cta2': 'Demoyu Planlayin',
    'pricing.table.lite': 'Lite',
    'pricing.table.standard': 'Standard',
    'pricing.table.full': 'Full QMS',
    'pricing.includes': 'Içerir',
    ...
    'cookie.message': 'Trafigi analiz etmek ve deneyiminizi iyilestirmek için çerez kullaniyoruz. Gizlilik Politikamizi inceleyin.',
