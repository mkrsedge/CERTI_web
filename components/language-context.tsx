...
const dict: I18nDict = {
  en: {
    ...
    'socialProof.heading': 'Trusted by quality teams in manufacturing',
    'socialProof.tagline': 'Replacing paper, spreadsheets, and email for quality teams in manufacturing',
    'socialProof.point1': 'Audit-ready workflows',
    'socialProof.point2': 'Faster CAPA closure',
    'socialProof.point3': 'Replacing paper, spreadsheets, and email',
    'startupPrograms.heading': 'Supported by leading startup and AI infrastructure programs',
  ...
  tr: {
    ...
    'socialProof.heading': 'Üretimde kalite ekipleri tarafından tercih ediliyor',
    'socialProof.tagline': 'Üretimdeki kalite ekiplerinin kağıt, Excel ve e-posta süreçlerini dijitale taşıyoruz',
    'socialProof.point1': 'Denetime hazır iş akışları',
    'socialProof.point2': 'Daha hızlı DÖF/CAPA kapanışı',
    'socialProof.point3': 'Kağıt, Excel ve e-postadan dijitale geçiş',
    'startupPrograms.heading': 'Önde gelen girişim ve yapay zeka altyapı programları tarafından destekleniyor',
